...
final class InviteCreateAuditLog extends AuditLog {
  ...
  InviteCreateAuditLog({
    ...
    this.channelId,
  }) : super(AuditLogType.inviteCreate, guildId, userId, ctx: ctx);
}
...
final class InviteUpdateAuditLog extends AuditLog {
  ...
  }) : super(AuditLogType.inviteUpdate, guildId, userId, ctx: ctx);
}
...
final class InviteDeleteAuditLog extends AuditLog {
  ...
  InviteDeleteAuditLog({
    ...
    required this.inviteCode,
    this.channelId,
  }) : super(AuditLogType.inviteDelete, guildId, userId, ctx: ctx);
}
