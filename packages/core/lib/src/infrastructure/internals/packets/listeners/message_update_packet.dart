...
final class MessageUpdatePacket implements ListenablePacket {
  ...
  Future<void> listen(ShardMessage message, DispatchEvent dispatch) async {
    ...
    final messageCacheKey = _marshaller.cacheKey.message(channelId, messageId);
    ...
    final rawAfter = await _marshaller.serializers.message.normalize(payload);
    ...
    switch (guildId) {
      case String():
        dispatch<GuildMessageUpdateArgs>(
          ...
          payload: (
            before: before as GuildMessage?,
            after: after as GuildMessage,
          ),
        );
      default:
        dispatch<PrivateMessageUpdateArgs>(
          ...
          payload: (
            before: before as PrivateMessage?,
            after: after as PrivateMessage,
          ),
        );
    }
  }
